...
JSAG_OBJECT_MEMBER_NAMED(onConnect, defaultCallback)
JSAG_OBJECT_MEMBER_NAMED(onRead, defaultCallback)
JSAG_OBJECT_MEMBER_NAMED(onError, defaultCallback)
JSAG_OBJECT_MEMBER_NAMED(onClose, defaultCallback)
JSAG_OBJECT_END
