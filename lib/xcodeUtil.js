...
exports.getProject = function(projectPath, cb) {
  var projectDir = findFile(projectPath, /\.xcodeproj$/);
  if (projectDir) {
    var projectFile = path.join(projectDir, 'project.pbxproj');
    var project = xcode.project(projectFile);
    project.parse(function (err) {
      cb(err, new Project(projectFile, projectDir, projectPath, project));
    });
  } else {
...
var Project = function (projectFile, projectDir, projectPath, project) {
...
Project.prototype.getProjectPath = function () {
